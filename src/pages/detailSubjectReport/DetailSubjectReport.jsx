...
const DetailSubjectReport = () => {
  ...
  const renderRows = (data) => {
    return data ? (
      data.map((item) => (
        ...
        >
          <td className="hidden md:table-cell text-center p-4 font-semibold">
          ...
          <td
            className={`hidden md:table-cell text-center font-semibold ${
  ...
  //     return makeRequest
  //       .put(`/score-boards/${reportSubjectId}`, {
  //         updatedScores,
  //       })
  //       .then((res) => res.data);
  //   },
      ...
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          {/* <div className="flex gap-4 items-center">
            ...
            <FormModal type="create" table="DetailSubjectReport" />
          </div> */}
        </div>
      </div>
      {/* LIST */}
